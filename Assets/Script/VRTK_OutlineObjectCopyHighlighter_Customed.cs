...
namespace VRTK.Highlighters
{
    ...
    /// </example>
    [AddComponentMenu("VRTK/Scripts/Interactions/Highlighters/VRTK_OutlineObjectCopyHighlighter_Customed")]
    public class VRTK_OutlineObjectCopyHighlighter_Customed : VRTK_BaseHighlighter
    {
        ...
        public override void Initialise(Color? color = null, GameObject affectObject = null, Dictionary<string, object> options = null)
        {
            ...
            {
                stencilOutline = Instantiate((Material)Resources.Load("MyOutline"));
            }
            SetOptions(options);
            ResetHighlighter();
        }
